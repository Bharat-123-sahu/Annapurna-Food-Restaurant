...
// ---------- Public Routes ----------
ReviewRouter.get("/food/:foodId", getReviewsByUser);                // Get all reviews for a food
ReviewRouter.get("/restaurant/:restaurantId", getReviewsByRestaurant); // Get all reviews for a restaurant
